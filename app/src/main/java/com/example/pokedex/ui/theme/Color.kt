...
val BlackBackGround = Color(0xFF2b292c)

val HP = Color(0xFFff0002)
val ATK = Color(0xFFf08030)
val DEF = Color(0xFFf7ce2d)
val SA = Color(0xFF688fef)
val SD = Color(0xFF7ac64f)
val SPD = Color(0xFFf95787)
